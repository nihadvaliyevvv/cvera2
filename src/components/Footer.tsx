...
export default function Footer() {
  ...
  return (
      <footer className="bg-white text-gray-900 border-t border-gray-200 md:max-w-screen-xl mx-auto md:px-[60px]">
      {/* Dinamik kənar boşluqları ilə responsive container */}
      <div className="w-full max-w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 3xl:px-24 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-row justify-center items-start gap-4 sm:gap-6 md:gap-8 lg:gap-8 xl:gap-8">
            {/* Xidmətlər */}
