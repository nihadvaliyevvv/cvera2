...
export default function Footer() {
  ...
  return (
      ...
      {/* Footer bölməsi */}
      <footer className="bg-white text-gray-900 border-t border-gray-200 md:max-w-screen-8xl mx-auto" style={{marginBottom : '0px', paddingBottom: '0px', marginTop: '0px', paddingTop: '30px'}}>
        {/* Dinamik kənar boşluqları ilə responsive container - üst boşluq silindi */}
        <div className="w-full max-w-8xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 3xl:px-24 pt-8 pb-12 lg:pb-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 lg:gap-20 lg:ml-[200px] lg:mr-auto">
            {/* Logo və məlumat */}
            <div className="col-span-1 md:col-span-2">
              <img
                  src="/cveralogo.png"
                  alt="CVera Logo"
                  className="h-8 w-auto sm:h-10 mb-6"
            ...
            {/* Navigation bölmələri - Həmişə yan-yana */}
            <div className="col-span-1 md:col-span-2 flex flex-row justify-center items-start gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16">
              {/* Xidmətlər */}
              <div className="text-left flex-1">
                <h3 className="text-lg font-semibold text-gray-900 mb-6">Xidmətlər</h3>
                <ul className="space-y-4">
                  <li>
                    <Link href="/cv-yaratmaq" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm sm:text-base">
                      CV Yaratmaq
                    </Link>
                  </li>
                  <li>
                    <Link href="/templates" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm sm:text-base">
                      CV Şablonları
                    </Link>
                  </li>
                  <li>
                    <Link href="/pricing" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm sm:text-base">
                      Qiymətləndirilmə
                    </Link>
                  </li>
                </ul>
              ...
              {/* Ümumi */}
              <div className="text-left flex-1 lg:ml-auto lg:mr-[200px]">
                <h3 className="text-lg font-semibold text-gray-900 mb-6">Ümumi</h3>
                <ul className="space-y-4">
                  <li>
                    <Link href="/terms" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm sm:text-base">
                      İstifadə Şərtləri
                    </Link>
                  </li>
                  <li>
                    <Link href="/privacy" className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm sm:text-base">
                      Məxfilik Siyasəti
                    </Link>
                  </li>
