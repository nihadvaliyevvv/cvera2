...
export default function SocialShare({
  url = typeof window !== 'undefined' ? window.location.href : 'https://cvera.net',
  title = 'CVERA - AI ilə CV Yaratmaq',
  description = 'Süni intellekt dəstəyi ilə professional CV yaradın',
  className = ''
}: SocialShareProps) {
  ...
  const socialLinks = {
    ...
    twitter: `https://twitter.com/intent/tweet?url=${shareData.url}&text=${shareData.title}&via=cvera_net`,
