...
export default function DashboardV2({ user, onCreateCV, onEditCV }: DashboardV2Props) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 cursor-none">
      ...
      <header className="bg-white backdrop-blur-lg border-b border-gray-200 shadow-sm sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity group">
                ...
                <div className="hidden sm:block">
                  <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">CVERA</h1>
            ...
            <div className="flex items-center space-x-4">
              {/* User Tier Badge */}
              <div className={`hidden sm:flex items-center space-x-2 px-3 py-1.5 rounded-full bg-gradient-to-r ${getTierColor(userTier)} text-white shadow-sm`}>
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  ...
                  <span className="hidden sm:inline text-sm font-medium">Çıxış</span>
                </button>
              </div>
            </div>
          </div>
              ...
              <div className="hidden lg:block">
                <div className="w-40 h-40 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-20 h-20 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h8.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
              </div>
            </div>
