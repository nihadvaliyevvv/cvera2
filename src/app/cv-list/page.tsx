          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12">
            ...
            <div className="mt-8 text-center">
              <button
                onClick={fetchCVs}
                disabled={loading}
                className="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:bg-gray-50 disabled:cursor-not-allowed transition-all duration-200 font-medium"
              >
                {loading ? (
