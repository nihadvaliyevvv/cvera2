...
export default function Index2() {
  ...
  return (
    <div className="min-h-screen bg-white cursor-none">
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-blue-600 to-blue-800 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20" data-aos="fade-up">
            <div className="inline-block mb-4 sm:mb-6">
              <span className="px-4 sm:px-6 py-2 bg-white/20 text-white font-semibold rounded-full text-xs sm:text-sm tracking-wide uppercase">
                <span className="text-blue-200">Statistikalarımız</span>
              </span>
            </div>
            <p className="text-3xl sm:text-4xl  font-bold mb-4 sm:mb-6">
              <span className="text-blue-200">Uğura</span> Gedən Yolun <span className="text-blue-200">Başlanğıcı</span>
            </p>
            <p className="text-lg sm:text-xl text-blue-100 leading-relaxed max-w-3xl mx-auto px-4">
              <span className="text-blue-200">Yüzlərlə</span> karyera uğuruna dəstək vermiş <span className="text-blue-200">CVERA</span>-nın nəticələri
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div data-aos="fade-up" className="max-w-5xl mx-auto">
            <div className="inline-block mb-6 sm:mb-8">
              <span className="px-4 sm:px-6 py-2 bg-blue-100 text-blue-800 font-semibold rounded-full text-xs sm:text-sm tracking-wide uppercase">
                Karyeranızı zirvəyə daşımaq Üçün biz Hazırıq
              </span>
            </div>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-8 sm:mb-10 leading-tight">
              Uğurlu Karyeranız
              <br />
              <span className="text-blue-600">Bir Klik Uzaqlıqda</span>
            </h2>
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-12 sm:mb-16 leading-relaxed max-w-4xl mx-auto px-4">
                CVERA ilə karyera yolculuğunuzu asanlaşdırın. İndi bizimlə başlayın!
            </p>

            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-center mb-12 sm:mb-16 px-4">
              <Link href="/auth/register">
                <button className="group w-full sm:w-auto px-12 sm:px-14 lg:px-16 py-6 sm:py-7 lg:py-8 bg-blue-600 text-white font-bold rounded-2xl sm:rounded-3xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-4 hover:scale-110 transition-all duration-500 text-xl sm:text-2xl overflow-hidden relative border-2 border-blue-600 hover:border-blue-700">
                  ...
                  <span className="relative flex items-center justify-center gap-3 sm:gap-4">
                    CV Hazırlamağa Başlayın
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 group-hover:translate-x-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
                  </span>
                </button>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-8 lg:gap-12 text-base sm:text-lg text-gray-600 px-4">
              <div className="flex items-center gap-3 sm:gap-4 bg-white rounded-xl sm:rounded-2xl px-6 sm:px-8 py-3 sm:py-4 shadow-lg border border-blue-100 w-full sm:w-auto justify-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                </div>
                <span className="font-semibold">Ödənişsiz Başlayın</span>
              </div>
              <div className="flex items-center gap-3 sm:gap-4 bg-white rounded-xl sm:rounded-2xl px-6 sm:px-8 py-3 sm:py-4 shadow-lg border border-blue-100 w-full sm:w-auto justify-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="font-semibold">3 Dəqiqədə Hazır</span>
              </div>
              <div className="flex items-center gap-3 sm:gap-4 bg-white rounded-xl sm:rounded-2xl px-6 sm:px-8 py-3 sm:py-4 shadow-lg border border-blue-100 w-full sm:w-auto justify-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="font-semibold">Premium Hissiyyat</span>
              </div>
            </div>
          </div>
        </div>
