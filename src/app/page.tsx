            ...
            >
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 sm:mb-8 leading-tight">
                  ...
                  >
                   <span className="relative text-white px-4 py-2 transform -skew-y-2 block font-black drop-shadow-lg">
                      CVERA ilə yaradın!
                    </span>
                  </motion.span>
                </span>
                        ...
                        <div className="space-y-6 sm:space-y-8">
                          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 group text-center sm:text-left" data-aos="fade-right" data-aos-delay="600">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-gray-600 leading-relaxed text-base sm:text-lg">
                                Milyonlarla uğurlu CV-nin məlumatları ilə təkmilləşən süni intellekt, CV-nizi fərdi və ən optimal formada hazırlayır.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 group text-center sm:text-left" data-aos="fade-right" data-aos-delay="700">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-gray-600 leading-relaxed text-base sm:text-lg">
                                HR mütəxəssisləri və peşəkar dizaynerlər tərəfindən hazırlanmış, göz oxşayan və funksional şablonlar işə qəbul prosesində sizə üstünlük qazandırır.
                              </p>
                            </div>
                          </div>
