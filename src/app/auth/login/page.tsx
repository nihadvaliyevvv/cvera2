    ...
    <div className="min-h-screen bg-gray-50 flex relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
          <defs>
            <pattern id="diagonal-lines-login" patternUnits="userSpaceOnUse" width="100" height="100">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 relative overflow-hidden z-10">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-10" preserveAspectRatio="none">
          <defs>
            <pattern id="overlay-diagonal" patternUnits="userSpaceOnUse" width="50" height="50">
              <path d="M 0,50 l 50,-50 M -12.5,12.5 l 25,-25 M 37.5,62.5 l 25,-25" stroke="white" strokeWidth="1"/>
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#overlay-diagonal)"/>
        </svg>
              ...
              <div className="w-full h-full bg-blue-300 rounded-3xl relative overflow-hidden shadow-2xl">
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-48 h-64 bg-amber-100 rounded-t-full shadow-lg">
                  ...
                  <div className="absolute top-8 left-1/2 transform -translate-x-1/2 w-20 h-24 bg-amber-200 rounded-full">
                    ...
                    {/* Beard */}
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-8 bg-amber-900 rounded-b-full"></div>
                  </div>
                  {/* Body */}
                  <div className="absolute top-24 left-1/2 transform -translate-x-1/2 w-32 h-40 bg-gray-700 rounded-t-3xl">
                    ...
                    <div className="absolute top-4 -right-8 w-16 h-6 bg-amber-200 rounded-full transform rotate-12">
                      {/* Hand with laptop gesture */}
                      <div className="absolute -bottom-2 right-2 w-6 h-4 bg-gray-800 rounded transform rotate-12"></div>
                    </div>
                  </div>
                </div>
                {/* Laptop */}
                <div className="absolute bottom-20 right-8 w-16 h-12 bg-gray-800 rounded transform rotate-12">
                  <div className="w-full h-8 bg-gray-300 rounded-t"></div>
                </div>
                {/* Floating elements */}
                <div className="absolute top-12 left-8 w-8 h-8 bg-white/30 rounded-full"></div>
                <div className="absolute top-20 right-12 w-6 h-6 bg-white/20 rounded-full"></div>
                <div className="absolute bottom-32 left-12 w-4 h-4 bg-white/25 rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8 bg-white rounded-2xl shadow-2xl p-8 md:p-10 border border-gray-100 backdrop-blur-sm bg-white/95">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            >
              ...
              <span className="text-gray-700 font-medium">LinkedIn ilə daxil ol</span>
            </button>
